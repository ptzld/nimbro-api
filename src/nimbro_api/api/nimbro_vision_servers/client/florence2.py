...
from ..base.florence2_base import Florence2Base

default_settings = {
    'logger_severity': None,
    'logger_name': "Florence2",
    'message_results': True,
    'endpoints': {
        'AIS': {
            'api_url': "https://api-code.ais.uni-bonn.de/v1/vision/florence2",
            'key_type': "environment",
            'key_value': "AIS_API_KEY"
        },
        'localhost': {
            'api_url': "http://localhost:9038",
            'key_type': "environment",
    ...
    'flavor': "large",
    'prompt': {'task_prompt': "<OD>", 'prompt_args': None},
    'num_beams': 3,
    'max_new_tokens': 1024,
    'max_batch_size': 6,
    'timeout_connect': 2.0,
    'timeout_read': 5.0,
    'timeout_read_load': 100.0,
    'timeout_read_infer': 5.0,
    'retry': 2
}

class Florence2(Client):
    """
    This is an implementation of the NimbRo Vision Servers API for Florence-2 (https://github.com/AIS-Bonn/nimbro_vision_servers/tree/main/models/florence2),
    ...
    def __init__(self, settings=None, **kwargs):
        """
        Create a client implementing the NimbRo Vision Servers API for Florence-2 (https://github.com/AIS-Bonn/nimbro_vision_servers/tree/main/models/florence2).
    ...
    def get_settings(self, name=None):
        ...
        Settings:
            ...
            prompt (dict):
                ...
                - Dense region captioning: `{'task_prompt': "<DENSE_REGION_CAPTION>", 'prompt_args': None}`
                - Object detection: `{'task_prompt': "<OD>", 'prompt_args': None}`
            num_beams (int):
