...
### No public endpoint currently available

# def test_2_endpoint():
#     client = Classify(
#         endpoint={
#             'name': "robo4",
#             'api_url': "http://robo4:8000/classify",
#             'models_url': "http://robo4:8000/v1/models",
#             'key_type': "plain",
#             'key_value': ""
#         },
#         retry=False,
...
#     success, message, classification = client.classify(prompt="This is a test.")
#     assert_type_value(obj=success, type_or_value=bool, name="success")
#     assert_type_value(obj=message, type_or_value=str, name="message")
#     assert_log(expression=success, message=message)
#     assert_type_value(obj=classification, type_or_value=dict, name="result of classify()")
